...
import com.silvercommunity.system.domain.NursingProject;
import com.silvercommunity.system.service.INursingProjectService;
...
public class NursingProjectController extends BaseController
{
     ...
     * 查询护理项目列表
     */
    @PreAuthorize("@ss.hasPermi('nur:project:list')")
    @GetMapping("/list")
     ...
     * 导出护理项目列表
     */
    @PreAuthorize("@ss.hasPermi('nur:project:export')")
     ...
     * 获取护理项目详细信息
     */
    @PreAuthorize("@ss.hasPermi('nur:project:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增护理项目
     */
    @PreAuthorize("@ss.hasPermi('nur:project:add')")
     ...
     * 修改护理项目
     */
    @PreAuthorize("@ss.hasPermi('nur:project:edit')")
     ...
     * 删除护理项目
     */
    @PreAuthorize("@ss.hasPermi('nur:project:remove')")
